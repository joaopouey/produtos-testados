...
const Newsletter = () => {
  return (
    <section className="flex bg-[#002642] text-white py-8 md:py-0 px-4 m-4 mt-8 rounded-[10px] flex-col md:flex-row md:h-28 md:justify-center">
      ...
      <div className="flex flex-col mt-4 w-[100%] md:w-96 lg:w-[505px] sm:mt-4 sm:ml-2 md:mt-2 md:ml-6 lg:mt-3">
