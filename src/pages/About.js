  ...
  return (
    <div className="container mx-auto py-10 px-4 text-center">
      ...
      <p className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto">
        Nossa equipe analisa os itens mais bem avaliados, considerando também o
        volume de opiniões para garantir uma seleção confiável e relevante.
      </p>
      <p className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto">
        Assim, ajudamos nossos leitores a escolher com confiança e segurança as
