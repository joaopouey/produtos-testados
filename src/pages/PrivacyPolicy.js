    ...
    <div className="container mx-auto py-10 px-4">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          nosso site é importante para o produtostestados.com.br.
        </p>
        <p>
          ...
          de outubro de 1998 (Lei n.º 67/98).
        </p>
        <p>
          A informação pessoal recolhida pode incluir o seu nome, e-mail, número
          de telefone e/ou telemóvel, data de nascimento e/ou outros.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          A informação contida nos anúncios, inclui o seu endereço IP (Internet
          Protocol), o seu ISP (Internet Service Provider, como o Sapo, Clix ou
          outro), o browser que utilizou ao visitar o nosso website (como o
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          publicidade de Lisboa apenas aos leitores oriundos de Lisboa, por ex.)
          ou apresentar publicidade direcionada a um tipo de utilizador (como
          mostrar publicidade de restaurante a um utilizador que visita sites de
          culinária regularmente, por ex.).
        </p>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
          O produtostestados.com.br possui ligações para outros sites, os quais,
      ...
      <section className="mb-6">
        ...
        <p>
          Este site de serviços permitem que este Site seja parte ativa junto de
          produtos ou serviços oferecidos. Os anúncios poderão ser exibidos com
          links afiliados e o administrador deste Site poderá ganhar comissão
          por qualquer compra realizada através desses links.
        </p>
        <p>
