...
const productTypesData = {
  'robos-aspiradores': {
    ...
    description:
      'Encontre os melhores robôs aspiradores de 2024, escolhidos com base nas avaliações de especialistas.',
    products: [
      {
        rank: 'TOP 1',
        name: 'Robô aspirador de pó ULTRA',
        description:
          'Robô aspirador de alta eficiência e baixa manutenção para uma limpeza automática em sua casa.',
      ...
      },
      {
        ...
        description:
          'Robô aspirador com mop integrado, ideal para limpeza úmida e seca.',
      ...
      },
      {
        ...
        description:
          'Robô aspirador compacto e silencioso, ideal para apartamentos.',
